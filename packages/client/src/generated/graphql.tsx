...
export type CommunityMutationVariables = Exact<{
  options: CommunityArgs;
}>;
...
export const CommunityDocument = gql`
    mutation community($options: CommunityArgs!) {
...
export type CommunityMutationFn = Apollo.MutationFunction<CommunityMutation, CommunityMutationVariables>;

/**
 * __useCommunityMutation__
 *
 * To run a mutation, you first call `useCommunityMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCommunityMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [communityMutation, { data, loading, error }] = useCommunityMutation({
 *   variables: {
 *      options: // value for 'options'
 *   },
 * });
 */
export function useCommunityMutation(baseOptions?: Apollo.MutationHookOptions<CommunityMutation, CommunityMutationVariables>) {
        return Apollo.useMutation<CommunityMutation, CommunityMutationVariables>(CommunityDocument, baseOptions);
      }
export type CommunityMutationHookResult = ReturnType<typeof useCommunityMutation>;
export type CommunityMutationResult = Apollo.MutationResult<CommunityMutation>;
export type CommunityMutationOptions = Apollo.BaseMutationOptions<CommunityMutation, CommunityMutationVariables>;
