...
const Pricing: React.FC = () => {
  return (
    <div>
      <Banner />
      <Navbar />
      <section className="text-gray-700 body-font bg-gradient-to-r from-white to-gray-100">
        <div className="container px-5 mx-auto">
          <div className="relative flex flex-col text-center w-full mb-20">
            <div className="pt-10 relative z-10">
              <h1 className="text-4xl lg:text-6xl font-black mb-2 text-gray-900">
                Pricing Page
              </h1>
              <p className="lg:w-2/3 mx-auto leading-relaxed text-xl text-gray-700">
                Get access Pluto for free, or pay to get access to premium perks
              </p>
            </div>
            <svg
              className="select-none absolute top-0 left-0 -ml-48 z-0"
              width="404"
              height="404"
              fill="none"
              viewBox="0 0 404 404"
          ...
          <div className="flex flex-wrap -m-4">
            <div className="p-4 xl:w-1/3 md:w-1/2 w-full">
              <div className="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative z-10 bg-white overflow-hidden">
